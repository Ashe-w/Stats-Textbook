...
<div class="quiz-question">
  ...
  <label><input type="radio" name="q2" value="a"> Discrete variable</label><br>
  <label><input type="radio" name="q2" value="b"> Continuous variabl</label><br>
  <label><input type="radio" name="q2" value="c"> Nominal variable </label><br>
  <label><input type="radio" name="q2" value="d"> Ordinal variable</label><br><br>

  <button type="button" onclick="checkMC('q2', 'b', 'fb2')">Check answer</button>
