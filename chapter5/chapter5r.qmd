...
```
###    Visualizing and Summarizing the Distribution 
```{r}
#| echo: true
#| message: false
#| warning: false
...
prob2   # ~0.1688 
```
**Interpretation**: About 16.9% of the population have a body temperature of 97.5°F or lower. 
...
**Interpretation**: About 53.9% (difference due to rounding) of the population have a body temperature between 97.5°F and 98.6°F. 