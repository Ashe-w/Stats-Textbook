...
length(mathease_data) #used sample size 
```
...
#| message: false
#| warning: false
# Count occurrences of Yes (1) and No (0) 
...
#| message: false
#| warning: false
# Expected counts under the null hypothesis (50/50 distribution) 
...
chi_sq_result <- chisq.test(x = observed_counts, p = c(0.5, 0.5)) 
```
```{r}
#| echo: true
#| message: false
