...
\subsection{Step 2: Set the criteria for a decision.}\label{step-two}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#| label: fig{-}9.2}
\CommentTok{\#| fig{-}cap: "t{-}distribution with two{-}tailed rejection regions ($\textbackslash{}alpha = 0.05$)"}
...
\CommentTok{\# {-}{-}{-} Settings (edit these as needed) {-}{-}{-}}
\NormalTok{df }\OtherTok{\textless{}{-}} \DecValTok{49}
\NormalTok{alpha }\OtherTok{\textless{}{-}} \FloatTok{0.05}
\NormalTok{tcrit }\OtherTok{\textless{}{-}} \FunctionTok{qt}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ alpha}\SpecialCharTok{/}\DecValTok{2}\NormalTok{, df)}
...
\NormalTok{curve\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =} \FunctionTok{dt}\NormalTok{(x, df))}

\FunctionTok{ggplot}\NormalTok{(curve\_df, }\FunctionTok{aes}\NormalTok{(x, y)) }\SpecialCharTok{+}

  \CommentTok{\# T distribution line}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =} \StringTok{"T{-}Distribution"}\NormalTok{), }\AttributeTok{linewidth =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}

  \CommentTok{\# Rejection regions (tails only)}
  \FunctionTok{geom\_area}\NormalTok{(}
    \AttributeTok{data =} \FunctionTok{subset}\NormalTok{(curve\_df, x }\SpecialCharTok{\textless{}=} \SpecialCharTok{{-}}\NormalTok{tcrit),}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =} \StringTok{"Rejection Region"}\NormalTok{),}
    \AttributeTok{alpha =} \FloatTok{0.3}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{geom\_area}\NormalTok{(}
    \AttributeTok{data =} \FunctionTok{subset}\NormalTok{(curve\_df, x }\SpecialCharTok{\textgreater{}=}\NormalTok{ tcrit),}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =} \StringTok{"Rejection Region"}\NormalTok{),}
    \AttributeTok{alpha =} \FloatTok{0.3}
\NormalTok{  ) }\SpecialCharTok{+}

  \CommentTok{\# Critical value lines}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \SpecialCharTok{{-}}\NormalTok{tcrit, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =}\NormalTok{ tcrit,  }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}

  \CommentTok{\# Null line}
  \FunctionTok{geom\_vline}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{linetype =} \StringTok{"Null Hypothesis (Mean Diff = 0)"}\NormalTok{),}
    \AttributeTok{xintercept =} \DecValTok{0}\NormalTok{,}
    \AttributeTok{color =} \StringTok{"black"}
\NormalTok{  ) }\SpecialCharTok{+}

  \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"T{-}Distribution"} \OtherTok{=} \StringTok{"blue"}\NormalTok{), }\AttributeTok{name =} \ConstantTok{NULL}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"Rejection Region"} \OtherTok{=} \StringTok{"red"}\NormalTok{), }\AttributeTok{name =} \ConstantTok{NULL}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_linetype\_manual}\NormalTok{(}
    \AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"Null Hypothesis (Mean Diff = 0)"} \OtherTok{=} \StringTok{"dashed"}\NormalTok{),}
    \AttributeTok{name =} \ConstantTok{NULL}
\NormalTok{  ) }\SpecialCharTok{+}

  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{x =} \StringTok{"Standardized Difference in Sample Means (t)"}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Density"}
\NormalTok{  ) }\SpecialCharTok{+}

  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_size =} \DecValTok{12}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}
    \AttributeTok{legend.position =} \FunctionTok{c}\NormalTok{(}\FloatTok{0.72}\NormalTok{, }\FloatTok{0.62}\NormalTok{),}
    \AttributeTok{legend.background =} \FunctionTok{element\_rect}\NormalTok{(}\AttributeTok{fill =} \StringTok{"white"}\NormalTok{, }\AttributeTok{color =} \StringTok{"grey80"}\NormalTok{)}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#| label: fig{-}9.3}
\CommentTok{\#| fig{-}cap: "Normal distributions with equal vs. unequal variances"}
\CommentTok{\#| fig{-}width: 8}
\CommentTok{\#| fig{-}height: 4.6}
\CommentTok{\#| warning: false}
\CommentTok{\#| message: false}
...
\CommentTok{\# {-}{-}{-}{-} Parameters from the figure {-}{-}{-}{-}}
\NormalTok{x\_min }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{x\_max }\OtherTok{\textless{}{-}} \DecValTok{125}
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(x\_min, x\_max, }\AttributeTok{length.out =} \DecValTok{2000}\NormalTok{)}

\NormalTok{params }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{scenario =} \FunctionTok{c}\NormalTok{(}\StringTok{"Equal Variances (X: 0{-}125)"}\NormalTok{, }\StringTok{"Equal Variances (X: 0{-}125)"}\NormalTok{,}
               \StringTok{"Unequal Variances (X: 0{-}125)"}\NormalTok{, }\StringTok{"Unequal Variances (X: 0{-}125)"}\NormalTok{),}
  \AttributeTok{group    =} \FunctionTok{c}\NormalTok{(}\StringTok{"Group 1"}\NormalTok{, }\StringTok{"Group 2"}\NormalTok{, }\StringTok{"Group 1"}\NormalTok{, }\StringTok{"Group 2"}\NormalTok{),}
  \AttributeTok{mean     =} \FunctionTok{c}\NormalTok{(}\DecValTok{50}\NormalTok{, }\DecValTok{60}\NormalTok{, }\DecValTok{50}\NormalTok{, }\DecValTok{60}\NormalTok{),}
  \AttributeTok{sd       =} \FunctionTok{c}\NormalTok{(}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{20}\NormalTok{),}
  \AttributeTok{color    =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"darkgreen"}\NormalTok{, }\StringTok{"blue"}\NormalTok{, }\StringTok{"darkgreen"}\NormalTok{)}
\NormalTok{)}

\CommentTok{\# Build curve data}
\NormalTok{curve\_df }\OtherTok{\textless{}{-}} \FunctionTok{do.call}\NormalTok{(rbind, }\FunctionTok{lapply}\NormalTok{(}\FunctionTok{seq\_len}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(params)), }\ControlFlowTok{function}\NormalTok{(i)\{}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ params[i, ]}
  \FunctionTok{data.frame}\NormalTok{(}
    \AttributeTok{x =}\NormalTok{ x,}
    \AttributeTok{y =} \FunctionTok{dnorm}\NormalTok{(x, }\AttributeTok{mean =}\NormalTok{ p}\SpecialCharTok{$}\NormalTok{mean, }\AttributeTok{sd =}\NormalTok{ p}\SpecialCharTok{$}\NormalTok{sd),}
    \AttributeTok{scenario =}\NormalTok{ p}\SpecialCharTok{$}\NormalTok{scenario,}
    \AttributeTok{group =} \FunctionTok{sprintf}\NormalTok{(}\StringTok{"\%s (Mean=\%d, SD=\%d)"}\NormalTok{, p}\SpecialCharTok{$}\NormalTok{group, p}\SpecialCharTok{$}\NormalTok{mean, p}\SpecialCharTok{$}\NormalTok{sd),}
    \AttributeTok{mean =}\NormalTok{ p}\SpecialCharTok{$}\NormalTok{mean,}
    \AttributeTok{color =}\NormalTok{ p}\SpecialCharTok{$}\NormalTok{color}
\NormalTok{  )}
\NormalTok{\}))}

\CommentTok{\# Means for vlines/legend}
\NormalTok{means\_df }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(curve\_df[, }\FunctionTok{c}\NormalTok{(}\StringTok{"scenario"}\NormalTok{, }\StringTok{"group"}\NormalTok{, }\StringTok{"mean"}\NormalTok{, }\StringTok{"color"}\NormalTok{)])}

\FunctionTok{ggplot}\NormalTok{(curve\_df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ y, }\AttributeTok{color =}\NormalTok{ group)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{linewidth =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}
    \AttributeTok{data =}\NormalTok{ means\_df,}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{xintercept =}\NormalTok{ mean, }\AttributeTok{color =}\NormalTok{ group),}
    \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
    \AttributeTok{linewidth =} \FloatTok{0.8}\NormalTok{,}
    \AttributeTok{show.legend =} \ConstantTok{FALSE}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{scenario, }\AttributeTok{nrow =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(x\_min, x\_max)) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Scores"}\NormalTok{, }\AttributeTok{y =} \ConstantTok{NULL}\NormalTok{, }\AttributeTok{color =} \ConstantTok{NULL}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_color\_manual}\NormalTok{(}
    \AttributeTok{values =} \FunctionTok{setNames}\NormalTok{(means\_df}\SpecialCharTok{$}\NormalTok{color, means\_df}\SpecialCharTok{$}\NormalTok{group)}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_size =} \DecValTok{12}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter9_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#| label: fig{-}9.4}
\CommentTok{\#| fig{-}cap: "Two{-}tailed t{-}test with critical values $\textbackslash{}pm2.009$"}
\CommentTok{\#| fig{-}width: 8}
\CommentTok{\#| fig{-}height: 4.6}
\CommentTok{\#| warning: false}
\CommentTok{\#| message: false}
...
\NormalTok{df }\OtherTok{\textless{}{-}} \DecValTok{49}
\NormalTok{tcrit }\OtherTok{\textless{}{-}} \FloatTok{2.009}
\NormalTok{t\_stat }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\FloatTok{1.53}

\CommentTok{\# Curve data}
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{4}\NormalTok{, }\DecValTok{4}\NormalTok{, }\AttributeTok{length.out =} \DecValTok{2000}\NormalTok{)}
\NormalTok{curve\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{x =}\NormalTok{ x,}
  \AttributeTok{y =} \FunctionTok{dt}\NormalTok{(x, df)}
\NormalTok{)}

\CommentTok{\# Tail shading data}
\NormalTok{left\_tail  }\OtherTok{\textless{}{-}} \FunctionTok{subset}\NormalTok{(curve\_df, x }\SpecialCharTok{\textless{}=} \SpecialCharTok{{-}}\NormalTok{tcrit)}
\NormalTok{right\_tail }\OtherTok{\textless{}{-}} \FunctionTok{subset}\NormalTok{(curve\_df, x }\SpecialCharTok{\textgreater{}=}\NormalTok{  tcrit)}

\FunctionTok{ggplot}\NormalTok{(curve\_df, }\FunctionTok{aes}\NormalTok{(x, y)) }\SpecialCharTok{+}

  \CommentTok{\# t distribution curve}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =} \StringTok{"t{-}distribution"}\NormalTok{), }\AttributeTok{linewidth =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}

  \CommentTok{\# rejection regions}
  \FunctionTok{geom\_area}\NormalTok{(}\AttributeTok{data =}\NormalTok{ left\_tail,}
            \FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =} \StringTok{"Rejection Region"}\NormalTok{),}
            \AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_area}\NormalTok{(}\AttributeTok{data =}\NormalTok{ right\_tail,}
            \FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =} \StringTok{"Rejection Region"}\NormalTok{),}
            \AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{) }\SpecialCharTok{+}

  \CommentTok{\# critical value lines}
  \FunctionTok{geom\_vline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{linetype =} \StringTok{"Critical values: ±2.009"}\NormalTok{),}
             \AttributeTok{xintercept =} \SpecialCharTok{{-}}\NormalTok{tcrit,}
             \AttributeTok{color =} \StringTok{"black"}\NormalTok{,}
             \AttributeTok{linewidth =} \FloatTok{0.9}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{linetype =} \StringTok{"Critical values: ±2.009"}\NormalTok{),}
             \AttributeTok{xintercept =}\NormalTok{ tcrit,}
             \AttributeTok{color =} \StringTok{"black"}\NormalTok{,}
             \AttributeTok{linewidth =} \FloatTok{0.9}\NormalTok{) }\SpecialCharTok{+}

  \CommentTok{\# test statistic line}
  \FunctionTok{geom\_vline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =} \StringTok{"Test Statistic"}\NormalTok{),}
             \AttributeTok{xintercept =}\NormalTok{ t\_stat,}
             \AttributeTok{linewidth =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}

  \CommentTok{\# label for test statistic}
  \FunctionTok{annotate}\NormalTok{(}\StringTok{"label"}\NormalTok{,}
           \AttributeTok{x =}\NormalTok{ t\_stat,}
           \AttributeTok{y =} \FloatTok{0.02}\NormalTok{,}
           \AttributeTok{label =} \StringTok{"{-}1.53"}\NormalTok{,}
  ...
  \FunctionTok{scale\_color\_manual}\NormalTok{(}
    \AttributeTok{values =} \FunctionTok{c}\NormalTok{(}
      \StringTok{"t{-}distribution"} \OtherTok{=} \StringTok{"blue"}\NormalTok{,}
      \StringTok{"Test Statistic"} \OtherTok{=} \StringTok{"darkgreen"}
\NormalTok{    ),}
    \AttributeTok{name =} \ConstantTok{NULL}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_manual}\NormalTok{(}
    \AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"Rejection Region"} \OtherTok{=} \StringTok{"red"}\NormalTok{),}
    \AttributeTok{name =} \ConstantTok{NULL}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{scale\_linetype\_manual}\NormalTok{(}
    \AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"Critical values: ±2.009"} \OtherTok{=} \StringTok{"dashed"}\NormalTok{),}
    \AttributeTok{name =} \ConstantTok{NULL}
\NormalTok{  ) }\SpecialCharTok{+}
...
\NormalTok{  ) }\SpecialCharTok{+}
  ...
  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_size =} \DecValTok{12}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}
    \AttributeTok{legend.position =} \FunctionTok{c}\NormalTok{(}\FloatTok{0.78}\NormalTok{, }\FloatTok{0.80}\NormalTok{),}
    \AttributeTok{legend.background =} \FunctionTok{element\_rect}\NormalTok{(}\AttributeTok{fill =} \StringTok{"white"}\NormalTok{, }\AttributeTok{color =} \StringTok{"grey80"}\NormalTok{),}
    \AttributeTok{panel.grid.minor =} \FunctionTok{element\_blank}\NormalTok{()}
\NormalTok{  )}
\end{Highlighting}
...
\begin{verbatim}
Warning in annotate("label", x = t_stat, y = 0.02, label = "-1.53", size = 3, :
...
value you identified in (\textbf{step-two?}). If the \(t\) statistic is
larger, meaning farther out from the center of the distribution in
either direction, then a significant difference exists between the
groups.
