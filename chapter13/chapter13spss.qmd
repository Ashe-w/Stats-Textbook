# Analyzing Change and Adjusting for Covariates in SPSS {.unnumbered}
...
### 1.1	Running the repeated-measures ANOVA {.unnumbered}
...
#### 1.1.1  Assumption checking {.unnumbered}
...
#### 1.1.2  Between-Subjects Factor: MATHMOT {.unnumbered}
...
#### 1.1.3  Within-Subjects Factor: ContentArea {.unnumbered}
...
#### 1.1.4	Interaction: MATHMOT × ContentArea {.unnumbered}
...
### 1.2	Post Hoc Comparisons {.unnumbered}

#### 1.2.1  Visualize the Means {.unnumbered}
...
#### 1.2.2  Pairwise Comparisons  {.unnumbered}
...
#### 2.1.3   Pairwise Comparisons  {.unnumbered}
