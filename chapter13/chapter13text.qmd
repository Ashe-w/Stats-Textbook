...
ggplot(df, aes(x = "", y = value, fill = category)) +
  ...
  scale_fill_manual(values = c(
    "Between groups variation" = "#6b4f2a",   # brown
    "Variation due to Covariate" = "#6e6c6c", # light gray
    "Error Variation" = "#4e6a85"             # blue
  )) +
...
ggplot(df, aes(x = "", y = value, fill = category)) +
  ...
  scale_fill_manual(values = c(
    "Between groups variation" = "#6b4f2a",   # brown
    "Variation due to Covariate" = "#6e6c6c", # darker gray (matches image)
    "Error Variation" = "#4f6f8f"             # muted blue
  )) +
