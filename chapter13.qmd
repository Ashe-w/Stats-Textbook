...
1. **What is <div class="quiz-question">
  <p><strong>1.</strong> What is the key advantage of using a repeated-measures ANOVA?</p>

  <label><input type="radio" name="13q1" value="a"> It eliminates the need for a dependent variable.</label><br>
  <label><input type="radio" name="13q1" value="b"> It reduces error variance by accounting for individual differences.</label><br>
  <label><input type="radio" name="13q1" value="c"> It allows for the inclusion of multiple dependent variables.</label><br>
  <label><input type="radio" name="13q1" value="d"> It does not require any statistical assumptions.</label><br>

  <button type="button" onclick="checkMC('13q1', 'b', 'fb64')">Check answer</button>
  <p id="fb64" class="quiz-feedback"></p>
</div>

<div class="quiz-question">
  <p><strong>2.</strong> What does the term "sphericity" refer to in the context of repeated-measures ANOVA?</p>

  <label><input type="radio" name="13q2" value="a"> Equal variances within each group.</label><br>
  <label><input type="radio" name="13q2" value="b"> Equal sample sizes across groups.</label><br>
  <label><input type="radio" name="13q2" value="c"> Equal variances of differences between all combinations of related groups.</label><br>
  <label><input type="radio" name="13q2" value="d"> Equal means across all groups.</label><br>

  <button type="button" onclick="checkMC('13q2', 'c', 'fb65')">Check answer</button>
  <p id="fb65" class="quiz-feedback"></p>
</div>

<div class="quiz-question">
  <p><strong>3.</strong> What is the recommended post hoc procedure for a repeated-measures ANOVA to control for Type I error?</p>

  <label><input type="radio" name="13q3" value="a"> Tukey’s HSD</label><br>
  <label><input type="radio" name="13q3" value="b"> Bonferroni correction</label><br>
  <label><input type="radio" name="13q3" value="c"> Fisher’s LSD</label><br>
  <label><input type="radio" name="13q3" value="d"> Scheffé test</label><br>

  <button type="button" onclick="checkMC('13q3', 'b', 'fb66')">Check answer</button>
  <p id="fb66" class="quiz-feedback"></p>
</div>

<div class="quiz-question">
  <p><strong>4.</strong> What does a significant result in a repeated-measures ANOVA indicate?</p>

  <label><input type="radio" name="13q4" value="a"> All group means are equal.</label><br>
  <label><input type="radio" name="13q4" value="b"> The dependent variable is unrelated to the conditions tested.</label><br>
  <label><input type="radio" name="13q4" value="c"> The assumptions of sphericity have been violated.</label><br>
  <label><input type="radio" name="13q4" value="d"> There is a difference in at least one pair of group means.</label><br>

  <button type="button" onclick="checkMC('13q4', 'd', 'fb67')">Check answer</button>
  <p id="fb67" class="quiz-feedback"></p>
</div>

<div class="quiz-question">
  <p><strong>5.</strong> What does "partial eta squared" (η²<sub>P</sub>) represent in repeated-measures ANOVA?</p>

  <label><input type="radio" name="13q5" value="a"> The total variation in the dependent variable.</label><br>
  <label><input type="radio" name="13q5" value="b"> The proportion of total variance explained by between-groups effects after accounting for between-persons variance.</label><br>
  <label><input type="radio" name="13q5" value="c"> The difference between the group means.</label><br>
  <label><input type="radio" name="13q5" value="d"> The degree of correlation between independent and dependent variables.</label><br>

  <button type="button" onclick="checkMC('13q5', 'b', 'fb68')">Check answer</button>
  <p id="fb68" class="quiz-feedback"></p>
</div>

<div class="quiz-question">
  <p><strong>6.</strong> What is the role of a covariate in ANCOVA?</p>

  <label><input type="radio" name="13q6" value="a"> To control for variability in the dependent variable that is unrelated to the independent variable(s)</label><br>
  <label><input type="radio" name="13q6" value="b"> To act as an additional independent variable</label><br>
  <label><input type="radio" name="13q6" value="c"> To replace the independent variable in the model</label><br>
  <label><input type="radio" name="13q6" value="d"> To reduce between-group variance</label><br>

  <button type="button" onclick="checkMC('13q6', 'a', 'fb69')">Check answer</button>
  <p id="fb69" class="quiz-feedback"></p>
</div>