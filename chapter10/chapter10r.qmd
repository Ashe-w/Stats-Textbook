# Analyzing Differences Among More Than Two Groups in R {.unnumbered}
...
## 1	One-Way ANOVA {.unnumbered}

**Comparing Math Scores by School Type** 

### 1.1	Define Hypotheses {.unnumbered}
...
### 1.2	Check Assumptions {.unnumbered}
...
### 1.3	One-Way ANOVA Test {.unnumbered}
```{r}
#| echo: true
#| message: false
#| warning: false
...
### 1.4	Post-hoc Tests {.unnumbered}

#### 1.4.1	Bonferroni-Adjusted Pairwise t Tests {.unnumbered}
...
#### 1.4.2	Tukey’s HSD Test {.unnumbered}
```{r}
#| echo: true
#| message: false
#| warning: false
...
## 2	Two-Way Factorial ANOVA {.unnumbered}
...
## 3	Nonparametric Alternative: Kruskal-Wallis Test {.unnumbered}
