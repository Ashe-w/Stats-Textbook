# Analyzing Differences Among More Than Two Groups in SPSS {.unnumbered}
...
## 2.   One-Way ANOVA - Comparing Math Scores by School Type {.unnumbered}

### 2.1	Define Hypotheses {.unnumbered}
...
## 2.2	 Perform One-Way ANOVA with All Outputs Together {.unnumbered}
...
### 2.3  Check assumptions {.unnumbered}
...
### 2.4  One-Way ANOVA Test {.unnumbered}
...
### 2.5  Post-hoc Tests {.unnumbered}

#### 2.5.1	Bonferroni-Adjusted Pairwise t Tests {.unnumbered}
...
#### 2.5.2	Tukey’s HSD Test {.unnumbered}
...
## 3. Two-Way ANOVA - Comparing Math Scores by School Type and Gender {.unnumbered}
...
## 4. Nonparametric Alternative: Kruskal-Wallis Test {.unnumbered}
